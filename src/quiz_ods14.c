 ...
 *
 * @note Mudanças da v5.2.1 (Correção):
 * - Restaurado o bloco de desenho do Menu Principal, que havia sido removido acidentalmente.
 * - Garantido que todos os includes sigam o padrão "raylib/arquivo.h".
 */
